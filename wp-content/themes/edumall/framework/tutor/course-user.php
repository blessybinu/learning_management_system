...
if ( ! class_exists( 'Edumall_Course_User' ) ) {
	class Edumall_Course_User {
		...
		public function instructor_register() {
			...
			/*$response = [
				'success'  => false,
				'messages' => esc_html__( 'Email address is existing', 'edumall' ),
			];*/
			...
			if(!preg_match("/^([a-zA-Z' ]+)$/",$firstname) && $firstname == ''){
			    $response = [
					'success'  => false,
					'messages' => esc_html__( 'First name is required. Use valid characters.', 'edumall' ),
				];
			}
			...
			if(!preg_match("/^([a-zA-Z' ]+)$/",$lastname) && $lastname == ''){
			    $response = [
					'success'  => false,
					'messages' => esc_html__( 'Last name is required. Use valid characters.', 'edumall' ),
				];
			}
