...
class Instructor {
	...
	public function register_instructor(){
		...
		*/
		...
		$country        = sanitize_text_field(tutor_utils()->input_old('billing_country'));
		$phone          = sanitize_text_field(tutor_utils()->input_old('phone'));
		$experience     = sanitize_text_field(tutor_utils()->input_old('experience'));
		$subject        = sanitize_text_field(tutor_utils()->input_old('subject'));
		$curriculum     = sanitize_text_field(tutor_utils()->input_old('curriculum'));
		$instructor_about     = sanitize_text_field(tutor_utils()->input_old('instructor_about'));

		$explod_subject    = implode(',', $subject);
		$explod_curriculum = implode(',', $curriculum);
		...
		if ( ! is_wp_error($user_id)){
			...
			update_user_meta( $user_id, 'instructor_experience', $experience );
			update_user_meta( $user_id, 'phone_number', $phone );
			update_user_meta( $user_id, 'instructor_about', $instructor_about );
			update_user_meta( $user_id, 'instructor_country', $country );
			update_user_meta( $user_id, 'instructor_subject', $explod_subject );
			update_user_meta( $user_id, 'instructor_curriculum', $explod_curriculum );
