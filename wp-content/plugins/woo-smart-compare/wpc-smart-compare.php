...
! defined( 'WOOSC_VERSION' ) && define( 'WOOSC_VERSION', '4.0.5' );
		...
		if ( ! class_exists( 'WPCleverWoosc' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWoosc {
				...
				function woosc_nav_menu_items( $items, $args ) {
					...
					if ( $selected ) {
						$items .= '<li class="menu-item woosc-menu-item menu-item-type-woosc"><a href="' . self::woosc_get_page_url() . '"><span class="woosc-menu-item-inner" data-count="' . $this->woosc_get_count() . '">' . apply_filters( 'woosc_menu_item_label', esc_html__( 'Compare', 'woo-smart-compare' ) ) . '</span></a></li>';
					}
