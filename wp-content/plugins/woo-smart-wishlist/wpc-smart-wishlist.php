...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '2.8.4' );
		...
		if ( ! class_exists( 'WPCleverWoosw' ) ) {
			class WPCleverWoosw {
				...
				function woosw_nav_menu_items( $items, $args ) {
					...
					if ( $selected ) {
						$items .= '<li class="menu-item woosw-menu-item menu-item-type-woosw"><a href="' . self::get_url() . '"><span class="woosw-menu-item-inner" data-count="' . self::get_count() . '">' . apply_filters( 'woosw_menu_item_label', self::localization( 'menu_label', esc_html__( 'Wishlist', 'woo-smart-wishlist' ) ) ) . '</span></a></li>';
					}
