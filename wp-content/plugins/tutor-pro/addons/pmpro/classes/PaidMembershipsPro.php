...
class PaidMembershipsPro {
     ...
     * @since v.1.7.5
     */
    private function has_membership_access($course_id, $user_id=null){
        global $wpdb;
        ...
        return $has_membership_access ? true : $this->required_levels( $term_ids, true );
    }
    ...
    public function add_membership_required($price){
        return !($this->has_membership_access(get_the_ID())===true) ? __('Membership Required', 'tutor-pro') : __('Free', 'tutor-pro');
    }
    ...
    public function tutor_course_add_to_cart($html){
        ...
        $access_require = $this->has_membership_access(get_the_ID());
    ...
    public function pmpro_pricing() {
        ...
        $required_levels = $this->has_membership_access(get_the_ID());
